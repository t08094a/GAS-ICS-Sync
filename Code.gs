/*
* SOURCE: https://github.com/t08094a/GAS-ICS-Sync
*
*=========================================
...
var sourceCalendars = [                // The ics/ical urls that you want to get events from along with their target calendars (list a new row for each mapping of ICS url to Google Calendar)
  ...
  ["https://www.firemanager.de/portal/kalender/xxx.ics", "FireManager Alle Termine", "10"]
];
...
var defaultAllDayReminder = 840;          // Default reminder for all day events in minutes before the day of the event (-1 = no reminder, the value has to be between 0 and 40320)
                                          // See https://github.com/derekantrican/GAS-ICS-Sync/issues/75 for why this is neccessary.
                                          // 840 min => 10 o'clock the previous day
var overrideVisibility = "public";        // Changes the visibility of the event ("default", "public", "private", "confidential"). Anything else will revert to the class value of the ICAL event.
var addTasks = false;
